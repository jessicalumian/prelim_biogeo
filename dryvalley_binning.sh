...
#SBATCH -o /home/jemizzi/biogeo/scripts/report/dryvalley_bin.out
#SBATCH -e /home/jemizzi/biogeo/scripts/report/dryvalley_bin.err
...
# metabat2 binning ode
metabat -i 01_megahit/${name}/final.contigs.fa -a 03_binning/${name}/depth.txt -o 03_binning/${name} -v
