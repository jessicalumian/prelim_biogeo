#! /bin/bash -login
#SBATCH -p bmm
#SBATCH -J phorm_lagoon_mapdepth
#SBATCH -t 20:00:00
#SBATCH -N 1
#SBATCH -n 1
#SBATCH -c 4
...
#SBATCH -o /home/jemizzi/biogeo/scripts/report/phorm_lagoon_mapdepth.out
#SBATCH -e /home/jemizzi/biogeo/scripts/report/phorm_lagoon_mapdepth.err
